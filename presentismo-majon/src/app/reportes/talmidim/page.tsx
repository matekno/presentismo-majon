...
export default function ReportesTalmidimPage() {
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10 shadow-lg">
        <div className="max-w-lg mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-xl font-bold">{t('reportes.talmidim.title')}</h1>
      ...
      <main className="max-w-lg mx-auto px-4 py-6">
        {loading ? (
          <div className="text-center py-8">
            ...
            <p className="mt-2 text-gray-600">{t('reportes.talmidim.loading')}</p>
          </div>
        ) : data ? (
          <>
            {/* Summary */}
